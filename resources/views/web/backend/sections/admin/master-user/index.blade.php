...
@push('title')
    TransForKr4b | Master user
@endpush

@section('content')
<div class="p-4 pb-12 pt-20 sm:ml-72">
    <div class="my-4 text-center">
        <h2 class="text-xl font-extrabold leading-none tracking-tight text-gray-900 md:text-3xl lg:text-4xl dark:text-white">Master User <span class="bg-blue-100 text-blue-800 text-2xl font-semibold mr-2 px-2.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-2">Beta</span></h2>
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        ...
                        >
                            @csrf
                            <div>
                                <label for="name" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Nama User</label>
                                <div class="flex">
                            ...
                            <div class="flex flex-col items-center justify-center w-full">
                                <label for="logo" class="block text-sm font-medium text-gray-900 dark:text-white text-left self-start">Foto / Logo User</label>
...
<script>
    ...
    function getData(params, pageUrl = "{{ route('dashboard.master-user.getData') }}") {
        // Make a GET request using Axios with the provided params
        // axios.get("{{ route('dashboard.master-user.getData') }}", {
        //     params: params
        // })
        axios.get(pageUrl, {
            params: params
                ...
                `
                    <tr class="bg-white text-center border-b dark:bg-gray-800 dark:border-gray-700">
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <img class="w-auto h-10 rounded-full mx-auto" src="${assetUrl+'\/'+item.avatar}" alt="Rounded avatar">
                        </td>
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">${item.email_verified_at == null  ? 'Belum Terverifikasi' : 'Terverifikasi'}</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <button type="button" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Ganti Password</button>
                        </td>
    ...
    function handleDeleteAction(id) {
        ...
        confirmButton.addEventListener('click', () => {
            ...
            axios
                .post(`{{ route('dashboard.master-user.delete') }}`, {
                    _method: 'DELETE',
                    id: id
                })
                .then(response => {
    ...
    function createData() {
        ...
        axios.post("{{ route('dashboard.master-user.create') }}", formData)
            .then(response => {
                // Handle the response (e.g., show a success message)
    ...
    function updateData() {
        ...
        // Assuming you have a route named 'dashboard.master-user.update' for updating categories
        axios.post("{{ route('dashboard.master-user.update') }}", formData)
            .then(response => {
                // Handle the response (e.g., show a success message)
