        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 container mx-auto ">
            <div class="sm:px-16">
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:text-left text-center lg:py-16 z-10 relative">
                    <a href="#" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-primary-700 bg-primary-100 rounded-full dark:bg-primary-900 dark:text-primary-300 hover:bg-primary-200 dark:hover:bg-primary-800">
                        <span class="text-xs bg-primary-600 rounded-full text-white px-4 py-1.5 mr-3">New</span> <span class="text-sm font-medium">Jumbotron component was launched! See what's new</span>
                    ...
                    <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-200">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
                    <form class="w-full max-w-md mx-auto lg:mx-0 lg:mr-auto">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="default-email" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-800 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter your email here..." required>
                            <button type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign up</button>
                        </div>
                    </form>
                </div>
            ...
            <div class="flex justify-center items-center order-first lg:order-last">
                <img class="h-auto lg:max-w-lg max-w-md w-52 sm:w-full rounded-lg rotate-3" src="{{ asset('development/image/logo.png') }}" alt="image description">
            </div>
        </div>

    </section>

    <section class="bg-white dark:bg-gray-900 py-6 wave-bg">
        <div class="container px-2 mx-auto flex flex-col justify-center items-center">
            <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl lg:text-5xl dark:text-white border-l-8 border-primary-300 pl-2.5 bg-gradient-to-r from-primary-900 py-0.5">Students Project</h1>
            <p class="text-lg font-normal text-gray-500 lg:text-xl text-center max-w-2xl dark:text-gray-400">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
        </div>

        <div class=" w-full h-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-2 md:gap-x-6 md:gap-y-6 gap-y-4 container mx-auto rounded-xl p-4 mt-4">

            {{-- search bar --}}
            <div class="mx-auto w-full max-w-2xl px-4 mt-4 col-span-full">
                <form>
                    <div class="flex w-full">
                        ...
                        <div class="relative w-full">
                            <input type="search" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-lg border-l-gray-50 border-l-2 border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-l-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-primary-500" placeholder="Search Mockups, Logos, Design Templates..." required>
                            <button type="submit" class="absolute top-0 right-0 p-2.5 text-sm font-medium h-full text-white bg-primary-700 rounded-r-lg border border-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
            ...
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img class="rounded-t-lg" src="{{ asset('development/image/thumbnail-project.jpg') }}" alt="" />
                </a>
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Gathering In Bali</h5>
                    </a>
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Web Application for selling ticket to an event, CMS & Payment Gateaway Included.</p>
                    <div class="flex -space-x-4">
                        <img class="w-10 h-10 border-2 border-white rounded-full dark:border-gray-800" src="http://localhost/person.png" alt="">
                        <img class="w-10 h-10 border-2 border-white rounded-full dark:border-gray-800" src="http://localhost/person.png" alt="">
                        <img class="w-10 h-10 border-2 border-white rounded-full dark:border-gray-800" src="http://localhost/person.png" alt="">
                        <a class="flex items-center justify-center w-10 h-10 text-xs font-medium text-white bg-gray-700 border-2 border-white rounded-full hover:bg-gray-600 dark:border-gray-800" href="#">+3</a>
                    </div>
                    ...
                    <div class="my-4">
                        ...
                        <div class="flex flex-wrap w-full space-y-1 items-baseline justify-start space-x-1">
                            <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">#Laravel</span>
                            <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">#Tailwind</span>
                            <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">#Flowbite</span>
                            <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">#Vite</span>
                            <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">#Axioo</span>
                            <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">#Midtrans</span>
                        </div>
                        <div class="flex items-center mt-3">
                            ...
                            <p class="ml-2 text-sm font-bold text-gray-900 dark:text-white">125</p>
            ...
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Blog Hamska Studio</h5>
                    </a>
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Blog / News Portal made using wordpress & elementor</p>
                    <div class="flex -space-x-4">
                        <img class="w-10 h-10 border-2 border-white rounded-full dark:border-gray-800" src="http://localhost/person.png" alt="">
                        <img class="w-10 h-10 border-2 border-white rounded-full dark:border-gray-800" src="http://localhost/person.png" alt="">
                        <img class="w-10 h-10 border-2 border-white rounded-full dark:border-gray-800" src="http://localhost/person.png" alt="">
                    ...
                    <div class="my-4">
                        ...
                        <div class="flex flex-wrap w-full space-y-1 items-baseline justify-start space-x-1">
                            <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">#Wordpress</span>
                            <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">#Elementor</span>
                            <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">#Blog</span>
                        </div>
                        <div class="flex items-center mt-3">
                            <svg class="w-4 h-4 text-yellow-300 mr-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                                <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
            ...
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">HamsyPy</h5>
                    </a>
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">A Simple Discord Bot made using discord.js library</p>
                    <div class="flex -space-x-4">
                        <img class="w-10 h-10 border-2 border-white rounded-full dark:border-gray-800" src="http://localhost/person.png" alt="">
                        <img class="w-10 h-10 border-2 border-white rounded-full dark:border-gray-800" src="http://localhost/person.png" alt="">
                        <img class="w-10 h-10 border-2 border-white rounded-full dark:border-gray-800" src="http://localhost/person.png" alt="">
            ...
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Perpus App</h5>
                    </a>
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">A Simple Discord Bot made using discord.js library</p>
                    <div class="flex -space-x-4">
                        <img class="w-10 h-10 border-2 border-white rounded-full dark:border-gray-800" src="http://localhost/person.png" alt="">
        ...
        {{-- <svg width="2000" height="1400" class="" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h2000v1400H0z"/><path d="M0 700h0c71.075-36.284 142.15-72.567 218-74 75.85-1.433 156.477 31.986 230 77 73.523 45.014 139.943 101.624 211 77 71.057-24.624 146.75-130.48 226-131 79.25-.52 162.056 104.297 234 107 71.944 2.703 133.026-96.707 208-142 74.974-45.293 163.838-36.47 238 9s133.62 127.588 216 146c82.38 18.412 187.68-26.882 228-49 40.32-22.118 15.66-21.059 31-20" fill="none" stroke="#ffab53" stroke-width="5" stroke-linecap="round"/></svg> --}}

    </section>

    <section class="bg-white dark:bg-gray-900 py-6 bg-[url({{ asset('development/image/wave-pattern.svg') }})]">
        <div class="container px-2 mx-auto flex flex-col justify-center items-center">
            <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl lg:text-5xl dark:text-white border-l-8 border-primary-300 pl-2.5 bg-gradient-to-r from-primary-900 py-0.5">Our Students</h1>
            <p class="text-lg font-normal text-gray-500 lg:text-xl text-center max-w-2xl dark:text-gray-400">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
        </div>

        <div class=" w-full h-auto grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-2 md:gap-x-6 md:gap-y-6 gap-y-4 container mx-auto rounded-xl p-4 mt-4">
            ...
            {{-- Card --}}
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="bg-card-pattern flex justify-center items-center py-8">
                    <img class="w-20 h-20 p-1 rounded-full ring-2 ring-primary-300 dark:ring-primary-500" src="http://localhost/person.png" alt="Bordered avatar">
                </div>


                <div class="p-5 border-t mt-1 border-primary-300 text-center">
                    <a href="#">
                        <h5 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Radja Aulia Al Ramdani</h5>
                    </a>
                    {{-- <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">XII RPL 2</p> --}}
                    <span class="bg-rose-100 text-rose-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-rose-900 dark:text-rose-300">XII</span>
                    <span class="bg-rose-100 text-rose-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-rose-900 dark:text-rose-300">RPL 2</span>

                    <div class="flex mt-3 space-x-2.5 justify-center items-baseline flex-wrap space-y-3">
                    ...
                    <div class="mt-2 mb-5 flex flex-wrap w-full space-y-1 items-baseline justify-center space-x-1">
                        <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">#Laravel</span>
                        <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">#Tailwind</span>
                        <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">#Flowbite</span>
                        <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">#Vite</span>
                        <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">#Axioo</span>
                        <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">#Midtrans</span>
                        <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">+5</span>
                    </div>
                    ...
                    <div class="flex space-x-2 items-center justify-center">
                        <button type="button" class="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700">
                            ...
                            See Portfolio
                            <svg class="w-3 h-3 ml-2 rotate-90 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
            ...
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5 border-t mt-1 border-primary-300 text-center">
                    <a href="#">
                        <h5 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Yoru</h5>
                    </a>
                    {{-- <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">XII RPL 2</p> --}}
                    <span class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">X</span>
                    <span class="bg-slate-100 text-slate-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-slate-900 dark:text-slate-300">PPLG 3</span>
